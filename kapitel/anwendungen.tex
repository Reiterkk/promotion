...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\textwidth]{homolumoarmchair}
	\captionsetup{figurewithin = chapter}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\textwidth]{homolumozigzag}
	\captionsetup{figurewithin = chapter}
