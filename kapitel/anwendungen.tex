...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.95\textwidth]{1bohr}
	\captionsetup{figurewithin = chapter}
...
\hline \hline
Verbindung &gemessen &\multicolumn{2}{c}{PBE, opt} &\multicolumn{2}{c}{PBE} &\multicolumn{2}{c}{BP86} &\multicolumn{2}{c}{B3LYP} &\multicolumn{2}{c}{PBE0} &\multicolumn{2}{c}{HF}\\
