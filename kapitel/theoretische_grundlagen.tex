...
%  	\end{aligned}  
     ...
     Der erste Term in Gleichung \ref{eq:enachb} und $\sum_{\mu\nu}\sum_{\kappa\lambda}D_{\mu\nu}D_{\kappa\lambda}^{B_\beta}G_{\mu\nu\kappa\lambda}$      lassen sich wieder zusammenfassen und eliminieren. Mit der Ableitung der Basisfunktionen nach dem Magnetfeld
     ...
     \end{aligned}
     \end{equation}
  	 ist $h_{\mu\nu}^{B_\beta}$ gegeben durch
  	 
  	 \begin{equation}
  	 h_{\mu\nu}^{B_\beta}=\frac{\iu}{2c}\left\langle\chi_\mu^{\vec{B}=0}\left\vert\left(\vec{R}_{\mu\nu}\times\vec{r}\right)_\beta\hat{h}\right\vert\chi_\nu^{\vec{B}=0}\right\rangle+\left\langle\chi_\mu^{\vec{B}=0}\left\vert\hat{T}^{B_\beta}\right\vert\chi_\nu^{\vec{B}=0}\right\rangle,
  	 \end{equation}
  	
  	 \textcolor{myred}{wobei ausgenutzt wurde, dass ...}
    ...
    \begin{equation}
    \begin{aligned}    
    h_{\mu\nu}^{\mu_{K_\alpha}B_\beta}=&\frac{\iu}{2c}\left\langle\chi_\mu^{\vec{B}=0}\left\vert\left(\vec{R}_\mu\times\vec{r}\right)_\beta\hat{T}^{\mu_{K_\alpha}}-\left(\vec{R}_\nu\times\vec{r}\right)_\beta \hat{T}^{\mu_{K_\alpha}}+\frac{\iu}{c}\left(\vec{R}_\nu\vec{r}_K\delta_{\alpha\beta}-\vec{R}_{\nu \beta}\vec{r}_{K_\alpha}\right)\right\vert\chi_\nu^{\vec{B}=0}\right\rangle\\
    &+\left\langle\chi_\mu^{\vec{B}=0}\vert\hat{T}^{\mu_{K_\alpha}B_\beta}\vert\chi_\nu^{\vec{B}=0}\right\rangle
    \end{aligned}
    \end{equation}
