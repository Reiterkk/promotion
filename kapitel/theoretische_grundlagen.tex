...
In der Praxis werden die Einelektronen-Wellenfunktionen $\phi_i$ in einer finiten Basis entwickelt. Bei dem sogenannten \aclu*{lcao-}\mbox{(\acs{lcao}-)}\acused{lcao}Ansatz werden die $\phi_i$ durch die Linearkombination der Basisfunktionen $\chi_\mu$ gebildet,
\begin{equation}
