...
%  	\end{aligned}  
     ...
     \begin{equation}
     \begin{aligned}
       h_{\mu\nu}^{\mu_{K_\alpha}}=&\frac{\partial}{\partial \mu_{K_\alpha}}\left(\langle\chi_\mu\vert\hat{H}\vert\chi_\nu\rangle\right)_{\vec{\mu}_K=\vec{B}=0}=\left\langle\chi_\mu\left\vert\left(\frac{\partial}{\partial \mu_{K_\alpha}}\hat{H}\right)_{\vec{\mu}_K=\vec{B}=0}\right\vert\chi_\nu\right\rangle\\
       =&\left\langle\chi_\mu\left\vert\hat{T}^{\mu_{K_\alpha}}\right\vert\chi_\nu\right\rangle
     \end{aligned}
     \end{equation}
     und 
     \begin{equation}
