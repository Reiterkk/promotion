...
\begin{figure}[ht!]
	...
	\captionsetup{figurewithin = chapter}
	\captionsetup{font=small, labelfont=bf}\caption[\ac{ir} und \ac{vcd} Spektren von (\textit{R})- und (\textit{S})-Methyloxiran]{Keilstrichformel von (\textit{R})[blau]- und (\textit{S})[rot]-Methyloxiran (a), gemeinsames \ac{ir} Spektrum (b) und unterschiedliche \ac{vcd} Spektren (c).}
\label{abb:vcdintro}
\end{figure}
	\subsection{Theorie}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.6\textwidth]{irppy3}
	\captionsetup{figurewithin = chapter}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.6\textwidth]{irppy3_vcd}
	\captionsetup{figurewithin = chapter}
	\captionsetup{font=small, labelfont=bf}\caption[]{}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.6\textwidth]{cpa_vcd}
	\captionsetup{figurewithin = chapter}
	\captionsetup{font=small, labelfont=bf}\caption[\ac{vcd} Spektren von \ac{cpa}]{\ac{vcd} Spektren von \ac{cpa}.}
\label{abb:cpa_vcd}
\end{figure}

\begin{table}\label{tab:vcdrechenzeit}
\captionsetup{tablewithin = chapter}
\captionsetup{font=small, labelfont=bf}
\captionabove[Rechenzeiten für \ac{vcd} Spektren]{.}
\resizebox{\textwidth}{!}{%
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.6\textwidth]{carboncluster_vcd}
	\captionsetup{figurewithin = chapter}
	\captionsetup{font=small, labelfont=bf}\caption[\ac{vcd} Spektren von ikosaedrischen Kohlenstoffclustern]{\ac{vcd} Spektren von ikosaedrischen Kohlenstoffclustern mit \textit{I}- aber nicht \textit{I}$_\textrm{h}$-Symmetrie.}
...
\begin{figure}[ht!]
	...
	\captionsetup{figurewithin = chapter}
	\captionsetup{font=small, labelfont=bf}\caption[Skalierung von \texttt{mpshift} und \texttt{aoforce}]{Skalierungsverhalten von \texttt{mpshift} und \texttt{aoforce} in \ac{vcd} Rechnungen.}
