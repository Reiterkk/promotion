...
\FloatBarrier
    ...
    ist ein deutlich größerer Aufwand erforderlich. Wie bereits in Kapitel \ref{theo:nmr} beschrieben, lässt sich die \ac{mo}-Ableitung nach einer Komponente des externen magnetischen Feldes im Rahmen des \ac{cphf}-Formalismus als 
