...
\begin{acronym}[SEPSEP] % längste Abkürzung steht in eckigen Klammern
    ...
    \acro{cnt}[CNT]{\textit{Carbon Nanotube}}	
 	...
 	\acro{cosmors}[COSMO-RS]{COSMO \textit{for Real Solvents}}

    \acro{cpa}[CPA]{Cryptophan-A} 	
 	
	\acro{cphf}[CPHF]{\textit{Coupled Perturbed Hartree-Fock}}
	
	\acro{csm}[CSM]{\textit{Continuum Solvatiol Model}}
	
	\acro{cvd}[CVD]{\textit{Chemical Vapor Deposition}}
	
	\acro{dcosmors}[D-COSMO-RS]{\textit{Direc}t COSMO \textit{for Real Solvents}}
    ...
    \acro{nhc}[NHC]{N-Heterocyclische Carbene}
    ...
    \acro{rik}[RI-K]{\textit{Resolution of the Identity for K}}
